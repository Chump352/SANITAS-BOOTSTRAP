...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Welcome to your Network Device Breakdown </h2>
            <div class="line"></div>
                ...
                <div class="col-sm-6">
                    <div class="card shadow mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h6 class="text-primary fw-bold m-0">Device Split</h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center small mt-4">
                                <span class="me-2">
                                    <i class="fas fa-circle text-primary"></i>&nbsp;Workstation
                                </span>
                                <span class="me-2"><i class="fas fa-circle text-success"></i>&nbsp;Router</span>
                                <span class="me-2"><i class="fas fa-circle text-info"></i>&nbsp;Server</span>
                            </div>
